...
In collaboration with Heather Goad, I am examining whether children acquiring two languages with distinct representations for word-level stress (such as French and English) are able to differentiate between the two language systems. We hypothesize that, in this case, two patterns might be observed: prosodic transfer and prosodic structure blend (one of the systems is imposed on top of the other one).
...
See my CV for publications related to other research projects.
